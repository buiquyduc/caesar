...
public class AccountController implements Serializable {
    ...
    private String currentPage = "/pages/account/List.xhtml";
    ...
    public void viewAccount() {
        if (accountId != null && JsfUtil.isNumeric(accountId)) {
            ...
            if (account != null) {
                ...
                currentPage = "/pages/account/View.xhtml";
                return;
            }
        }

        accounts = accountFacade.findAll();
        currentPage = "/pages/account/List.xhtml";
    }
    ...
    public void prepareEditAccount(Integer id) {
        if (accountExist(id)) {
            currentPage = "/pages/account/Edit.xhtml";
        }
    }
    ...
    public void prepareCreateAccount() {
        ...
        currentPage = "/pages/account/Create.xhtml";
    }

...
public class CustomerController implements Serializable {
    ...
    private String currentPage = "/pages/customer/Grid.xhtml";
    private Part image;
    ...
    public void prepareCreateCustomer() {
        ...
        currentPage = "/pages/customer/Create.xhtml";
    ...
    public void prepareEditCustomer(Integer id) {
        if (customerExist(id)) {
            imageModified = false;
            currentPage = "/pages/customer/Edit.xhtml";
        }
    }
    ...
    public void cancelCustomerEdit(Integer id) {
        if (customerExist(id)) {
            partner.setCountry(countries.get(partner.getCountry()));
            currentPage = "/pages/customer/View.xhtml";
        }
    }
...
//    }
    ...
    public void viewCustomer() {
        ...
        partners = null;
        currentPage = "/pages/customer/Grid.xhtml";
    }
    ...
    public void showCustomers() {
        ...
        if (isGridView) {
            ...
            currentPage = "/pages/customer/List.xhtml";
        }
    }
    ...
    public void updatePartnerType() {
        ...
        if (searchKey != null && !searchKey.isEmpty() && currentPage.equals("/pages/customer/Grid.xhtml")) {
            searchByName();
        }
    }

...
import net.vedp.dao.InventoryFacade;
...
public class InventoryController implements Serializable {
    ...
    private String currentPage = "/pages/inventory/List.xhtml";
    ...
    public void viewInventory() {
        if (inventoryId != null && JsfUtil.isNumeric(inventoryId)) {
            ...
            if (productInventory != null) {
                ...
                currentPage = "/pages/inventory/View.xhtml";
                return;
            }
        }

        inventory = inventoryFacade.findAll();
        currentPage = "/pages/inventory/List.xhtml";
    }

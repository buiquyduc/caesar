...
public class InvoiceController implements Serializable {
    ...
    private String currentPage = "/pages/invoice/List.xhtml";
    ...
    private void setSaleOrderStatus() {
        if (invoice.getSaleOrder() != null) {
            ...
            if (saleOrderInvoiced == true) {
                ...
                if (null != invoice.getSaleOrder() && null != invoice.getSaleOrder().getInvoices()){
                	invoices.addAll(invoice.getSaleOrder().getInvoices());
                }
    ...
    public void viewInvoice() {
        if (invoiceId != null && JsfUtil.isNumeric(invoiceId)) {
            ...
            if (invoice != null) {
                ...
                currentPage = "/pages/invoice/View.xhtml";
                findOutstandingPayments();
                return;
            }
        }
        ...
        if (saleId != null && JsfUtil.isNumeric(saleId)) {
            ...
            if ((invoices != null) && (!invoices.isEmpty())) {
                currentPage = "/pages/invoice/List.xhtml";
...
//        
        ...
        currentPage = "/pages/invoice/Create.xhtml";
    }
    ...
    public void prepareEdit(Integer id) {
        ...
        if (invoiceExist(id)) {
            if (invoice.getState().equals("Draft")) {
                ...
                currentPage = "/pages/invoice/Edit.xhtml";

...
import net.vedp.dao.JournalEntryFacade;
...
public class JournalEntryController implements Serializable {
    ...
    String currentPage = "/pages/journalEntry/List.xhtml";
    ...
    public void viewJournalEntry() {
        ...
        if (journalEntryId != null && JsfUtil.isNumeric(journalEntryId)) {
            ...
            if (journalEntry != null) {
                ...
                currentPage = "/pages/journalEntry/View.xhtml";
                return;
            }
        }
        ...
        if (partnerId != null && JsfUtil.isNumeric(partnerId)) {
            ...
            if (!journalEntries.isEmpty()) {
                currentPage = "/pages/journalEntry/ListByPartner.xhtml";
                return;
            }
        }

        journalEntries = journalEntryFacade.findAll();
        currentPage = "/pages/journalEntry/List.xhtml";
    }

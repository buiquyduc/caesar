...
public class PaymentController implements Serializable {
    ...
    String currentPage = "/pages/payment/List.xhtml";
    ...
    private boolean paymentExist(Integer id) {
        if (id != null) {
            ...
            if (payment == null) {
                ...
                currentPage = "/pages/payment/List.xhtml";
                return false;
            } else {
                return true;
            }
    ...
    public void cancelEdit(Integer id) {
        if (paymentExist(id)) {
            currentPage = "/pages/payment/View.xhtml";
        }
    }
    ...
    public void prepareEdit(Integer id) {
        if (paymentExist(id)) {
            if (payment.getState().equals("Draft")) {
                ...
                currentPage = "/pages/payment/Edit.xhtml";
            } else {
    ...
    public void prepareCreate() {
        ...
        paymentType = "receive money";
        topNCustomers = paymentFacade.findTopNCustomers(4);
        currentPage = "/pages/payment/Create.xhtml";
    }

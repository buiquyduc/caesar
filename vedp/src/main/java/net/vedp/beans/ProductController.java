...
import net.vedp.validation.StrictlyPositiveNumber;
...
public class ProductController implements Serializable {
    ...
    private String currentPage = "/pages/product/Grid.xhtml";
    private Part image;
    ...
    public void duplicateProduct(Integer id) {
        if (productExist(id)) {
            ...
            currentPage = "/pages/product/Create.xhtml";
        }
    }
    ...
    public void prepareViewProduct() {
        if (productExist(product.getId())) {
            currentPage = "/pages/product/View.xhtml";
        }
    }
    ...
    public void prepareEditProduct(Integer id) {
        if (productExist(id)) {
            imageModified = false;
            currentPage = "/pages/product/Edit.xhtml";
        }
    }
    ...
    private boolean productExist(Integer id) {
        if (id != null) {
            ...
            if (product == null) {
                ...
                products = null;
                currentPage = "/pages/product/Grid.xhtml";
                return false;
            } else {
                return true;
            }
    ...
    public void showProducts() {
        ...
        if (isGridView) {
            ...
            currentPage = "/pages/product/List.xhtml";
        }
    }

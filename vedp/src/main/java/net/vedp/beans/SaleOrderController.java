...
import static net.vedp.beans.util.Countries.Version.SECOND;
...
import net.vedp.beans.util.Countries;
import net.vedp.beans.util.JsfUtil;
import net.vedp.beans.util.Status;
import net.vedp.dao.SaleOrderFacade;
import net.vedp.entities.DeliveryOrder;
import net.vedp.entities.DeliveryOrderLine;
import net.vedp.entities.Invoice;
import net.vedp.entities.InvoiceLine;
import net.vedp.entities.InvoiceTax;
...
public class SaleOrderController implements Serializable {
    ...
    private String currentPage = "/pages/saleOrder/List.xhtml";
    ...
    public void updateOrder(Integer id) {
        if (getOrderStatus(id) != null) {
            if (!getOrderStatus(id).equals("Quotation")) {
                ...
                currentPage = "/pages/saleOrder/View.xhtml";
    ...
    public void deleteOrder(Integer id) {
        if (saleOrderExist(id)) {
            if (saleOrder.getState().equals("Cancelled")) {
                ...
                currentPage = "/pages/saleOrder/List.xhtml";
            } else {
            ...
            if (saleOrder.getState().equals("To Invoice") && saleOrder.getInvoiceMethod().equals("Partial")) {
                ...
                if (saleOrderLines != null && !saleOrderLines.isEmpty()) {
                    ...
                    if (redirect) {
                        ...
                        context.redirect(context.getRequestContextPath() + "/pages/invoice/index.xhtml?id=" + InvId);
                    }
                }
            } else {
                JsfUtil.addWarningMessageDialog("InvalidAction", "ErrorAlreadyModified");
    ...
    public void showOrderLineForm() {
        if (saleOrderLines != null && saleOrderLines.size() > 0) {
            ...
            currentPage = "/pages/saleOrder/ViewByProduct.xhtml";
        }
    }
    ...
    public void prepareCreate() {
        ...
        currentPage = "/pages/saleOrder/Create.xhtml";
    }
    ...
    public void prepareEdit(Integer id) {
        if (saleOrderExist(id)) {
            if (saleOrder.getState().equals("Quotation")) {
                ...
                currentPage = "/pages/saleOrder/Edit.xhtml";
            } else {
    ...
    public void viewSaleOrder() {
        ...
        if (JsfUtil.isNumeric(productId)) {
            ...
            if (!saleOrderLines.isEmpty()) {
                currentPage = "/pages/saleOrder/ListByProduct.xhtml";
                return;
            }
        }

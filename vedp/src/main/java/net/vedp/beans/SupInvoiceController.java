...
public class SupInvoiceController implements Serializable {
    ...
    private String currentPage = "/pages/supInvoice/List.xhtml";
    ...
    private void setPurchaseOrderStatus() {
        ...
        if (invoice.getPurchaseOrder() != null) {
            ...
            if (null != invoice.getPurchaseOrder() && null != invoice.getPurchaseOrder().getInvoices()){
            	invoices.addAll(invoice.getPurchaseOrder().getInvoices());
            }
    ...
    public void viewInvoice() {
        if (invoiceId != null && JsfUtil.isNumeric(invoiceId)) {
            ...
            if (invoice != null) {
                ...
                currentPage = "/pages/supInvoice/View.xhtml";
                findOutstandingPayments();
                return;
            }
        }
        ...
        if (purchaseId != null && JsfUtil.isNumeric(purchaseId)) {
            ...
            if ((invoices != null) && (!invoices.isEmpty())) {
                currentPage = "/pages/supInvoice/List.xhtml";
...
//        }
        ...
        currentPage = "/pages/supInvoice/Create.xhtml";
    }
    ...
    public void prepareEdit(Integer id) {
        ...
        if (invoiceExist(id)) {
            if (invoice.getState().equals("Draft")) {
                ...
                currentPage = "/pages/supInvoice/Edit.xhtml";

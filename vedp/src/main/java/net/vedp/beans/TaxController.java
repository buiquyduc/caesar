...
import net.vedp.dao.TaxFacade;
import net.vedp.entities.Tax;
...
public class TaxController implements Serializable {
    ...
    private String currentPage = "/pages/tax/List.xhtml";
    ...
    public void deleteTax(Integer id) {
        if (taxExist(id)) {
            ...
            currentPage = "/pages/tax/List.xhtml";
            taxes.remove(tax);
            tax = null;
    ...
    public void cancelEditTax(Integer id) {
        if (taxExist(id)) {
            currentPage = "/pages/tax/View.xhtml";
        }
    }
    ...
    public void prepareCreateTax() {
        ...
        currentPage = "/pages/tax/Create.xhtml";
    }
    ...
    public void prepareEditTax(Integer id) {
        if (taxExist(id)) {
            currentPage = "/pages/tax/Edit.xhtml";
        }
    }

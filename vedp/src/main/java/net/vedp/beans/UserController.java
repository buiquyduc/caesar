...
import net.vedp.dao.UserFacade;
...
public class UserController implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 9099871628791841824L;
	@Inject
    ...
    private String currentPage = "/pages/userInfo/List.xhtml";
    ...
    public void deleteUser(Integer id) {
        if (userExist(id)) {
            ...
            currentPage = "/pages/userInfo/List.xhtml";
            users.remove(user);
            user = null;
    ...
    public void cancelEditUser(Integer id) {
        if (userExist(id)) {
            currentPage = "/pages/userInfo/View.xhtml";
        }
    }
    ...
    public void prepareCreateUser() {
        ...
        currentPage = "/pages/userInfo/Create.xhtml";
    }
    ...
    public void prepareEditUser(Integer id) {
        if (userExist(id)) {
            imageModified = false;
            currentPage = "/pages/userInfo/Edit.xhtml";
        }
    }

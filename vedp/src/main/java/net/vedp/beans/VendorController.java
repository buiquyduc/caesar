...
import net.vedp.dao.PartnerFacade;
...
public class VendorController implements Serializable {
    ...
    private String currentPage = "/pages/supplier/Grid.xhtml";
    private Part image;
    ...
    public void prepareCreateSupplier() {
        ...
        currentPage = "/pages/supplier/Create.xhtml";
    ...
    public void prepareEditSupplier(Integer id) {
        if (vendorExist(id)) {
            imageModified = false;
            currentPage = "/pages/supplier/Edit.xhtml";
        }
    }
    ...
    public void cancelSupplierEdit(Integer id) {
        if (vendorExist(id)) {
            partner.setCountry(countries.get(partner.getCountry()));
            currentPage = "/pages/supplier/View.xhtml";
        }
    }
...
//    }
    ...
    public void viewSupplier() {
        ...
        partners = null;
        currentPage = "/pages/supplier/Grid.xhtml";
    }
    ...
    public void showVendors() {
        ...
        if (isGridView) {
            ...
            currentPage = "/pages/supplier/List.xhtml";
        }
    }
    ...
    public void updatePartnerType() {
        ...
        if (searchKey != null && !searchKey.isEmpty() && currentPage.equals("/pages/supplier/Grid.xhtml")) {
            searchByName();
        }
    }
